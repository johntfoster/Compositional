...
\begin{enumerate}[leftmargin=*]
	...
	permeability.  The pulled-back conversion-corrected mobility
	\(J\mbf F^{-1}\widetilde{\bs\lambda}_f\mbf F^{-T}\) is a likely source of
	missing terms, especially because
	\(\widetilde{\bs\lambda}_f\) itself contains
