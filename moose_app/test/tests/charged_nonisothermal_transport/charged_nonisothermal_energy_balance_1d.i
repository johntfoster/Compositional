...
[Postprocessors]
  ...
  [net_outward_reference_heat_flux]
    ...
    pp_names = 'right_reference_heat_flux_x left_reference_heat_flux_x'
    pp_coefs = '1 -1'
  []
