...
[Functions]
  ...
  [summed_reference_component_0_exact]
    type = ParsedFunction
    expression = '(1+0.2*x)*0.25*2*0.4'
  []
  [summed_reference_component_1_exact]
    type = ParsedFunction
    expression = '(1+0.2*x)*0.25*2*0.6'
  []
[]
...
[Postprocessors]
  ...
  [direct_summed_reference_component_0_global_balance]
    ...
    pp_names = 'right_reference_component_0_flux_x left_reference_component_0_flux_x'
    pp_coefs = '1 -1'
  []
  [direct_summed_reference_component_1_global_balance]
    type = LinearCombinationPostprocessor
    pp_names = 'right_reference_component_1_flux_x left_reference_component_1_flux_x'
    pp_coefs = '1 -1'
  []
[]
