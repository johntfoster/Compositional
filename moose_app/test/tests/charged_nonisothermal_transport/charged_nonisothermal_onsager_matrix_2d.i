...
[Functions]
  ...
  [neutral_potential_0_exact]
    type = ParsedFunction
    expression = '0.1+x+2*y'
  []
  [neutral_potential_1_backbone_exact]
    type = ParsedFunction
    expression = '-0.5*x+1.5*y'
  []
  ...
  [temperature_exact]
    type = ParsedFunction
    expression = '1.5+3*x+4*y'
  []
  [transport_force_0_antiderivative_exact]
    type = ParsedFunction
    expression = '1.25*x+0.5*y'
  []
  ...
  [summed_reference_component_0_exact]
    type = ParsedFunction
    expression = '(1.1*1.1)*0.25*2*0.4'
  []
  [summed_reference_component_1_exact]
    type = ParsedFunction
    expression = '(1.1*1.1)*0.25*2*0.6'
  []
[]
...
[Postprocessors]
  ...
  [direct_summed_reference_component_0_global_balance]
    ...
    pp_names = 'right_reference_component_0_flux_x left_reference_component_0_flux_x top_reference_component_0_flux_y bottom_reference_component_0_flux_y'
    pp_coefs = '1 -1 1 -1'
  []
  [direct_summed_reference_component_1_global_balance]
    type = LinearCombinationPostprocessor
    pp_names = 'right_reference_component_1_flux_x left_reference_component_1_flux_x top_reference_component_1_flux_y bottom_reference_component_1_flux_y'
    pp_coefs = '1 -1 1 -1'
  []
[]
