...
[Functions]
  # Q2 displacement and Q1 pressure fields are represented exactly by QUAD9/Q2 + P1.
  # Their time dependence is linear so the backward-Euler material rates are exact.
  [ux_exact]
    type = ParsedFunction
  ...
  [p_exact]
    type = ParsedFunction
    expression = '1+0.2*x+0.15*y+0.05*x*y+0.1*t'
  []
  ...
  [solid_reference_jacobian_exact]
    type = ParsedFunction
    expression = '(1+(0.04+0.01*t)*(1-2*x))*(1+(0.03+0.015*t)*(1-2*y))'
  []
  [fluid_intrinsic_density_exact]
    type = ParsedFunction
    expression = '2+0.5*(1+0.2*x+0.15*y+0.05*x*y+0.1*t)'
  []
  [summed_reference_component_storage_exact]
    type = ParsedFunction
    expression = '0.25*(1+(0.04+0.01*t)*(1-2*x))*(1+(0.03+0.015*t)*(1-2*y))*(2+0.5*(1+0.2*x+0.15*y+0.05*x*y+0.1*t))'
  []
  [summed_reference_component_storage_rate_exact]
    type = ParsedFunction
    expression = '0.25*((0.01*(1-2*x)*(1+(0.03+0.015*t)*(1-2*y))+(1+(0.04+0.01*t)*(1-2*x))*0.015*(1-2*y))*(2+0.5*(1+0.2*x+0.15*y+0.05*x*y+0.1*t))+(1+(0.04+0.01*t)*(1-2*x))*(1+(0.03+0.015*t)*(1-2*y))*0.05)'
  []
  ...
  [summed_reference_component_flux_divergence_exact]
    type = ParsedFunction
    expression = '-0.3*((1+(0.03+0.015*t)*(1-2*y))*(0.5*(0.2+0.05*y)^2/(1+(0.04+0.01*t)*(1-2*x))+2*(0.04+0.01*t)*(2+0.5*(1+0.2*x+0.15*y+0.05*x*y+0.1*t))*(0.2+0.05*y)/(1+(0.04+0.01*t)*(1-2*x))^2)+(1+(0.04+0.01*t)*(1-2*x))*(0.5*(0.15+0.05*x)^2/(1+(0.03+0.015*t)*(1-2*y))+2*(0.03+0.015*t)*(2+0.5*(1+0.2*x+0.15*y+0.05*x*y+0.1*t))*(0.15+0.05*x)/(1+(0.03+0.015*t)*(1-2*y))^2))'
  []
  ...
  [body_x]
    type = ParsedFunction
    expression = '-(3*(-2*(0.04+0.01*t))*(1+1/(1+(0.04+0.01*t)*(1-2*x))^2)+5*(-2*(0.04+0.01*t))*(1-log((1+(0.04+0.01*t)*(1-2*x))*(1+(0.03+0.015*t)*(1-2*y))))/(1+(0.04+0.01*t)*(1-2*x))^2-0.25*(0.2+0.05*y)*(1+(0.03+0.015*t)*(1-2*y)))'
  []
  [body_y]
    type = ParsedFunction
    expression = '-(3*(-2*(0.03+0.015*t))*(1+1/(1+(0.03+0.015*t)*(1-2*y))^2)+5*(-2*(0.03+0.015*t))*(1-log((1+(0.04+0.01*t)*(1-2*x))*(1+(0.03+0.015*t)*(1-2*y))))/(1+(0.03+0.015*t)*(1-2*y))^2-0.25*(0.15+0.05*x)*(1+(0.04+0.01*t)*(1-2*x)))'
  []
  [zero]
    type = ParsedFunction
    expression = '0'
