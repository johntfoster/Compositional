...
[Functions]
  ...
  [phase_density_exact]
    type = ParsedFunction
    expression = '0.4*2*exp(0.1*(2.5 - 1))'
  []
  [psi_exact]
    type = ParsedFunction
    expression = '((1 + 1/0.1) - (2.5 + 1/0.1)/exp(0.1*(2.5 - 1)))/2 + 0.25*(10 + 0.01*300*log(0.25)) + 0.75*(20 + 0.01*300*log(0.75))'
  []
  [storage0_exact]
    type = ParsedFunction
...
[AuxKernels]
  ...
  [phase_density_aux]
    type = ADMaterialRealAux
    variable = phase_density_from_eos
