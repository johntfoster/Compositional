...
[Functions]
  [theta_f_exact]
    type = ParsedFunction
    expression = '300+x^2+0.5*y^2'
  []
  [theta_s_exact]
    type = ParsedFunction
    expression = '330+0.25*x^2+1.5*y^2'
  []
  [fluid_flux_exact]
    type = ParsedFunction
    expression = '-2*(300+x^2+0.5*y^2)'
  []
  [solid_flux_exact]
    type = ParsedFunction
    expression = '-3*(330+0.25*x^2+1.5*y^2)'
  []
  [exchange_exact]
    type = ParsedFunction
    expression = '(4+0.01*x^2+0.005*y^2)*(30-0.75*x^2+y^2)'
  []
  ...
  [fluid_external_exact]
    type = ParsedFunction
    expression = '-6-(4+0.01*x^2+0.005*y^2)*(30-0.75*x^2+y^2)'
  []
  [solid_external_exact]
    type = ParsedFunction
    expression = '-10.5+(4+0.01*x^2+0.005*y^2)*(30-0.75*x^2+y^2)'
  []
  [zero]
