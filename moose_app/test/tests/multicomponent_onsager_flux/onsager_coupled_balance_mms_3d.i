...
[Functions]
  [mu0_exact]
    type = ParsedFunction
    expression = '1+x^2+0.5*y^2+0.25*z^2'
  []
  [mu1_exact]
    type = ParsedFunction
    expression = '2+0.25*x^2+1.5*y^2+0.75*z^2'
  []
  [flux0_exact]
    type = ParsedFunction
    expression = '-2*(1+x^2+0.5*y^2+0.25*z^2)-0.3*(2+0.25*x^2+1.5*y^2+0.75*z^2)'
  []
  [flux1_exact]
    type = ParsedFunction
    expression = '-0.3*(1+x^2+0.5*y^2+0.25*z^2)-1.5*(2+0.25*x^2+1.5*y^2+0.75*z^2)'
  []
  [reference_flux_exact]
    type = ParsedFunction
    expression = '2.3*(1+x^2+0.5*y^2+0.25*z^2)+1.8*(2+0.25*x^2+1.5*y^2+0.75*z^2)'
  []
[]
...
[Materials]
  ...
  [D01]
    type = ADGenericConstantRankTwoTensor
    tensor_name = D01
    tensor_values = '0.3 0 0  0 0.3 0  0 0 0.3'
  []
  [D10]
    type = ADGenericConstantRankTwoTensor
    tensor_name = D10
  ...
  [D11]
    type = ADGenericConstantRankTwoTensor
    tensor_name = D11
    tensor_values = '1.5 0 0  0 1.5 0  0 0 1.5'
  []
  [onsager]
