...
[Functions]
  ...
  [phi_exact]
    type = ParsedFunction
    expression = '(1+${drained_to_grain_bulk_ratio}*(((1+${strain_amp})^2)-1)+${finite_deformation_curvature}*(((1+${strain_amp})^2)-1)^2)/((1+${strain_amp})^2)'
  []
  [biot_finite_exact]
    type = ParsedFunction
    expression = '1-(${drained_to_grain_bulk_ratio}+2*${finite_deformation_curvature}*(((1+${strain_amp})^2)-1))'
  []
  ...
  [density_exact]
    type = ParsedFunction
    expression = '1/(1+${drained_to_grain_bulk_ratio}*(((1+${strain_amp})^2)-1)+${finite_deformation_curvature}*(((1+${strain_amp})^2)-1)^2)'
  []
[]
