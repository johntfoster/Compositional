...
[Functions]
  ...
  [uy_exact]
    type = ParsedFunction
    expression = '${strain_amp}*y'
  []
  [uz_exact]
    type = ParsedFunction
    expression = '${strain_amp}*z'
  []
  [pressure_exact]
    type = ParsedFunction
  ...
  [phi_exact]
    type = ParsedFunction
    expression = '(1+${drained_to_grain_bulk_ratio}*(((1+${strain_amp})^3)-1)+${finite_deformation_curvature}*(((1+${strain_amp})^3)-1)^2)/((1+${strain_amp})^3)'
  []
  [biot_finite_exact]
    type = ParsedFunction
    expression = '1-(${drained_to_grain_bulk_ratio}+2*${finite_deformation_curvature}*(((1+${strain_amp})^3)-1))'
  []
  ...
  [density_exact]
    type = ParsedFunction
    expression = '1/(1+${drained_to_grain_bulk_ratio}*(((1+${strain_amp})^3)-1)+${finite_deformation_curvature}*(((1+${strain_amp})^3)-1)^2)'
  []
[]
