...
[Functions]
  ...
  [eta_gas_1_exact]
    type = ParsedFunction
    expression = '0.8-0.05*x'
  []
  [z0_exact]
    type = ParsedFunction
    expression = '8/15+x/12'
  []
  [z1_exact]
    type = ParsedFunction
    expression = '7/15-x/12'
  []
  [pressure_exact]
    type = ParsedFunction
    expression = '2+x'
  ...
  [direct_summed_eq32_component0_reference_storage_exact]
    type = ParsedFunction
    expression = '1.1*(0.2*3*(0.7+0.1*x)+0.1*3*(0.2+0.05*x))'
  []
  [direct_summed_eq32_component1_reference_storage_exact]
    type = ParsedFunction
    expression = '1.1*(0.2*3*(0.3-0.1*x)+0.1*3*(0.8-0.05*x))'
  []
...
[Postprocessors]
  ...
  [component0_net_outward_reference_flux]
    ...
    pp_names = 'component0_right_reference_flux component0_left_reference_flux'
    pp_coefs = '1 -1'
  []
  [component1_net_outward_reference_flux]
    type = LinearCombinationPostprocessor
    pp_names = 'component1_right_reference_flux component1_left_reference_flux'
    pp_coefs = '1 -1'
  []
