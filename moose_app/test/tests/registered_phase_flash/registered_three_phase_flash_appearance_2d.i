...
[Functions]
  ...
  [phi_total_exact]
    type = ParsedFunction
    expression = '0.3 + if(x<0.5,0,0.05)'
  []
  [phi_oil_exact]
    type = ParsedFunction
    expression = '0.2'
  ...
  [eta_water_0_exact]
    type = ParsedFunction
    expression = 'if(x<0.5,0.75,1/3)'
  []
  [eta_water_1_exact]
    type = ParsedFunction
    expression = 'if(x<0.5,0.10,2/3)'
  []
  [storage0_exact]
    type = ParsedFunction
    expression = '0.3 + if(x<0.5,0,0.05)'
  ...
  [storage1_exact]
    type = ParsedFunction
    expression = '0.6 + 2*if(x<0.5,0,0.05)'
  []
  [oil_saturation_exact]
    type = ParsedFunction
    expression = '0.2/(0.3 + if(x<0.5,0,0.05))'
  []
  [gas_saturation_exact]
    type = ParsedFunction
    expression = '0.1/(0.3 + if(x<0.5,0,0.05))'
  []
  [water_saturation_exact]
    type = ParsedFunction
    expression = 'if(x<0.5,0,0.05)/(0.3 + if(x<0.5,0,0.05))'
  []
[]
