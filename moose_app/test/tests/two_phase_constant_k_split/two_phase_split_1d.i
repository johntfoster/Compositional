...
[AuxKernels]
  ...
  [s0_aux]
    type = ADMaterialRealAux
    variable = s0
    property = phase0_saturation
    execute_on = 'INITIAL TIMESTEP_END'
  []
  [s1_aux]
    type = ADMaterialRealAux
    variable = s1
    property = phase1_saturation
    execute_on = 'INITIAL TIMESTEP_END'
  []
  [phi0_aux]
    type = ADMaterialRealAux
  ...
  [x0_aux]
    type = ADMaterialRealAux
    variable = x0
    property = phase0_component_mass_fraction_0
    execute_on = 'INITIAL TIMESTEP_END'
  []
  [y0_aux]
    type = ADMaterialRealAux
    variable = y0
    property = phase1_component_mass_fraction_0
    execute_on = 'INITIAL TIMESTEP_END'
  []
  [storage0_aux]
    type = ADMaterialRealAux
  ...
  [volume_residual_aux]
    ...
    execute_on = 'INITIAL TIMESTEP_END'
  []
  [equilibrium_residual0_aux]
    type = ADMaterialRealAux
    variable = equilibrium_residual0
    property = constant_k_equilibrium_residual_0
    execute_on = 'INITIAL TIMESTEP_END'
  []
  [overall_residual0_aux]
    type = ADMaterialRealAux
    variable = overall_residual0
    property = overall_composition_residual_0
    execute_on = 'INITIAL TIMESTEP_END'
  []
[]
...
[Postprocessors]
  ...
  [volume_residual_l2]
    ...
    function = zero
  []
  [equilibrium_residual0_l2]
    type = ElementL2Error
    variable = equilibrium_residual0
    function = zero
  []
  [overall_residual0_l2]
    type = ElementL2Error
    variable = overall_residual0
    function = zero
  []
