% !TeX root = ../main.tex
\section{Derivation of the component Euler identity}
...
\eqref{eq:MC_solid_composition_projection}.  Thus the complete solid
composition coefficient has component-dependent part
\(\pi_s^\beta/\eta_s^\beta\); its remaining part is common to every component.
Because \(\sum_\beta\eta_s^\beta=1\), that common part cancels between the
component-\(\alpha\) coefficient and its mass-fraction-weighted sum in the
constituent-mass chain rule.  Combining this cancellation with the density
contribution gives
%
\begin{align}
	\hat\mu_s^\alpha
	...
	\qquad
	s\in\mc S .
	\label{eq:appendix_solid_weighted_composition_cancellation}
\end{align}
%
