...
the mechanism force power.  Define the reaction dissipation by
\begin{equation}
	\mc D_{\rm rxn}
	:=\sum_m\mc A_m\dot r_m .
	\label{eq:CN_reaction_dissipation}
\end{equation}
...
\end{align}
Admissible reaction kinetics must make $\mc D_{\rm rxn}\ge 0$, for example
...
\end{equation}
Equations \eqref{eq:CN_reaction_dissipation},
\eqref{eq:CN_interphase_exchange_positive}, and
