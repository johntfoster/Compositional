...
\begin{equation}
	...
	\dot\eta_s^\beta .
	\label{eq:CN_solid_component_density_rate}
\end{equation}
...
\begin{align}
	...
	\notag                                               \\
		...
		\notag                                               \\
	       & +\lambda\sum_\xi\dot\phi_\xi
		+\sum_\xi\sum_\alpha\frac{\tau_\xi^\alpha}{\phi_\xi}\dot\phi_\xi
		-\sum_l\gamma_l\dot\phi_l
		\notag                                               \\
	       &
...
\end{equation}
is the undistended intrinsic first Piola--Kirchhoff stress.  The distension
coefficient gives
\begin{equation}
