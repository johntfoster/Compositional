...
specific generalized transfer-work potentials; the conversion force consequently carries
...
transport.
\item \textbf{Plastic driving stress and the Biot--Terzaghi effective-stress
relation.}  The
...
Biot--Terzaghi effective-stress relation connects the two stresses, a
distinction that classical
...
into the separate distension yield surface.  Every mechanism is therefore
associated in its own stress space, which resolves the classical
non-associativity while preserving an associated flow rule throughout.  The
associated closures presented are admissible by construction, and the same
conjugate structure permits thermodynamically consistent non-associated
deformation--distension laws through \(\mbf S_s\) and the distension map
\(\mbf A_s\), governed by the dissipation-based criterion of hyperplasticity
\cite{houlsby2006principles}, provided the combined conjugate power in the
residual dissipation remains nonnegative.
\end{enumerate}
