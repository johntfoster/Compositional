...
Biot transform relates the two stresses.  The distinction between the
work-conjugate driving stress and the balance stress, which classical
effective-stress plasticity leaves implicit
\cite{bishop1959principle,borja2006mechanical}, is thereby made explicit, and
non-associativity enters through the dissipation-based criterion of
hyperplasticity \cite{houlsby2006principles}.  The associated closures presented
...
formulated through \(\mbf S_s\) and the distension map \(\mbf A_s\),
