...
\cite{leroy2004triple,newman2004electrochemical}.  The total free charge density is
%
\begin{equation}
	\varrho
	=
...
\(-\varrho\dot\varphi\).  In particular, representing fixed charge as a solid
component ties charge storage, deformation, reaction, and ion exchange to the
