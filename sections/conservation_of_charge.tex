...
\end{equation}
%
An independently prescribed bulk charge may be added as a known contribution
to the field-source coefficient \(\varrho\) in the electrical virtual work and
Gauss' law.  The same contribution then appears in the bulk field-source power
\(-\varrho\dot\varphi\).  It is not included in the component charge balances
below; any prescribed time dependence is part of the external loading protocol.
