...
Onsager stationarity principle then supplies near-equilibrium closures for
dynamic saturation redistribution, reaction, and component-relative
transport.  Separating these steps
distinguishes the balance and constraint equations that every admissible
process must satisfy from the material-specific closures that determine
...
\begin{enumerate}
	...
	\item Capillarity and electrostatics are generated from the same constrained
	      stored-energy construction.  The saturation constraint and a continuous
	      capillary-history state produce drainage--imbibition-dependent pressure
	      differences, while the history evolution contributes an explicit
	      dissipative force--rate product.  An optional positive-semidefinite
	      resistance relates the nonequilibrium pressure difference to the
	      skeleton-following saturation rate.  The phase electrical enthalpies add a
	      definite difference term to those pressure jumps while also generating
	      electric displacement, Maxwell stress, and dielectric pressure.  The
	      same stored potential therefore generates the electrocapillary law, the
	      electrically corrected equivalent pore pressure, and their contributions
	      to the phase momentum equations.
...
imbibition, and scanning paths.  Dynamic capillary pressure is admitted as an
