...
\begin{enumerate}
	...
	\item The plastic dissipation fixes the stress that drives plastic flow in a
	      ...
	      fixed-pressure skeleton stress entering the momentum balance.  This
	      separates the stress that performs plastic work from the balance
	      stress, and the same conjugate structure admits thermodynamically
	      consistent non-associated deformation--distension laws through the
	      driving stress and the distension map, provided the combined conjugate
	      power in the residual dissipation remains nonnegative.
\end{enumerate}
%
