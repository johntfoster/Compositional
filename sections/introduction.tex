...
\begin{enumerate}
	...
	\item Capillarity and electrostatics are generated from the same constrained
	      ...
	      pressure.  The same stored potential therefore generates the
	      electrocapillary law, the electrically corrected equivalent pore
	      pressure, and their contributions to the phase momentum equations.
...
relative permeabilities, kinetic data, and numerical algorithms.
