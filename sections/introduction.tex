...
reaction and component-relative transport.  Separating these steps
...
\begin{enumerate}
	...
	\item Capillarity and electrostatics are generated from the same constrained
	      ...
	      dissipative force--rate product.  The phase electrical enthalpies add a
...
imbibition, and scanning paths.  Dynamic capillary pressure and independent
interfacial-area evolution remain outside the present state.  The
