...
temperature, and capillary-history state,
%
\begin{equation}
...
pressure reconstruction gives the equivalent-pressure identity
...
reconstructions, and
\eqref{eq:reservoir_simulation_capillary_summary} is a history-dependent
