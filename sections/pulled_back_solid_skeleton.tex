...
\eqref{eq:standard_darcy_mass_flux_limit} directly.  The stored capillary law
sets the saturation- and history-dependent part of each phase-pressure
difference, the electrical enthalpy supplies its electrical correction, and the
Onsager resistance supplies the saturation-rate lag,
%
\begin{equation}
...
other fluid pressures from the stored capillary law, the electrical correction,
and the dynamic lag before evaluating the fluxes.  Because \(\mbf X\) follows
the skeleton,
...
time-discrete saturation rate enters the pressure reconstruction, and the
spatial gradient of the resulting pressure lag is carried by the Darcy flux.
Together with the Maxwell stress, the pressure reconstruction gives the
equivalent-pressure identity
...
reconstructions, and
\eqref{eq:reservoir_simulation_capillary_summary} is the combined stored,
electrical, and rate-dependent constitutive closure.  A
