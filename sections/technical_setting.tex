...
This appendix collects detailed observer transformations, gauge conditions, and
admissible initial and boundary data.  The notation and conventions needed to
follow the main derivation are introduced locally at their first substantive
use; the material below records the corresponding global consistency checks.
...
\eqref{eq:W_def}.  The natural phase traction is
