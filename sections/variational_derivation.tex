...
is written for a compositional mixture containing solid, aqueous, oleic, and gas
phases\footnote{The number and names of phases are illustrative; the derivation
	does not require this particular phase set.} with arbitrary components
$\alpha$ within each phase.
...
\begin{align}
	...
	\dv\dt \notag                                            \\
	 & \quad-\int_{t_1}^{t_2}\int_{\mc B}\sum_{(m)}
...
% AGENT-LOCK-END
%
Using \eqref{eq:capilary_pressure_def1}, the standard capillary pressure
...
reaction-induced filling; it does not by itself introduce a separate
distension-energy postulate.  The evolution of $a_s$ follows from mass balance
