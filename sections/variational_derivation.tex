...
\begin{align}
	...
	+ \int_{\mc{B}} \phi\,\gamma\left(\left\{S_f\right\}_{f\in\mc F}\right) \dv,
	\label{eq:U_def}                                                                                                                                                                                                \\
...
\eqref{eq:CN_solid_component_mass_identity},
...
\begin{equation}
	\begin{aligned}
		\rho_s\mbf a_s
		={} & \nabla_{\mbf x}\cdot\left(\bs\sigma_s^{\prime\prime} + (1 - B_s) \bar{p}_E \right)
		+\rho_s\mbf g+\mbf b_s
		-\phi_s\nabla_{\mbf x}\bar p_E
		+\sum_\alpha
...
$\widetilde\psi_s=\psi_s+\bar p_s^s \bar v_s^s$.  Thus the
