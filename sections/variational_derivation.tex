...
\cite{leverett1941capillary}.  The effective mobile interfacial energy density
is a single constitutive potential of the mobile saturations and temperature,
and it is not assumed to decompose into additive pair contributions:
% AGENT-LOCK-BEGIN equation-lock: do not edit unless explicitly unlocked by user
\begin{equation}
	\gamma =
