#!/usr/bin/env python3
"""Check the genuinely 2D Q2/EG black-oil well/source summed Eq. (32) MMS."""
...
DECK = (
    ...
    / "tests"
    / "black_oil_well"
    / "q2_eg_three_component_well_source_balance_2d.i"
)
...
EXPECTED_INTEGRALS = {
    "reference_domain_area": 6.0,
    "solid_reference_jacobian_integral": 1.32 * 6.0,
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="black_oil_q2_eg_well_source_mms_2d_") as tmp:
    ...
    if failures:
        raise SystemExit("2D black-oil Q2/EG well/source MMS failed: " + "; ".join(failures))
    ...
    print(
        "black_oil_q2_eg_well_source_balance_2d: "
